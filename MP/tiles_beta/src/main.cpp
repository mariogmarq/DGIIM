...
int main(int nargs, char * args[]) {
    ...
    if(!continuarPartida)
        cout << "%%%OUTPUT" << endl << legal.getScore() << endl << lang << endl;
    else
        outMatchfile << PASSWORD << endl << legal.getScore() << endl << lang << endl;
    tiles.print(*os);
